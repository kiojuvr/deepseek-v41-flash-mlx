...
printf '%s\n' \
 'scope=1 model; resident official layout; one transactional 2063-token sweep + 1 reference decode; production fixed-tile attention baseline' \
...
RUN_CONDITIONS=${RUN_CONDITIONS:-resident-transactional-sweep-production-fixed-tile-baseline} \
