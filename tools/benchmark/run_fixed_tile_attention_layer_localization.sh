...
printf '%s\n' \
 ...
 'result=reports first layer/stage crossing RMS 0.002 plus layer 3/4 and 20/21 arithmetic attribution; layers 3 and 20 report mismatch selected widths, while layer 3 retains native-width-one QK/AV substitutions; final state equality is intentionally not asserted after semantic divergence; diagnostic only, not qualification or performance' \
