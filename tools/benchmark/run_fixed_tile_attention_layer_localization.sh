...
printf '%s\n' \
 ...
 'result=reports first layer/stage crossing RMS 0.002 plus layer 3/4 arithmetic attribution; layer 3 also reports mismatch selected widths and separate native-width-one QK/AV substitutions; final state equality is intentionally not asserted after semantic divergence; diagnostic only, not qualification or performance' \
