...
printf '%s\n' \
  'scope=1 model; model-lifetime 40-layer resident atlas; 2063-token optimized prefill + 1 decode; Phase 1/2/3 full-path observation' \
...
CACHE_CONDITION=unknown RUN_CONDITIONS=model-lifetime-resident-chunk-mhc-expert-major \
