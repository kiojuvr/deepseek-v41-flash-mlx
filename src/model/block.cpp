...
BlockReference::BlockReference(WeightCatalog& c,int layer):layer_(checked_pure_swa_layer(layer)),attn_mix_(c,checked_pure_swa_layer(layer),"attn"),ffn_mix_(c,layer,"ffn"),attention_(c,layer),moe_(c,layer),
